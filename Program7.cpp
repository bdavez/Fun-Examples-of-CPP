...
/*
 ...
 Variables:
    ...
    line - a string that temperarily stores information from getline() function
...
/*
 ...
 Discussion:
    ...
    After text document is loaded in it will read out the text document one line at a time waiting for user input (enter key)
